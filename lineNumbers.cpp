...
int main(){
    ...
    int lineNum = 1;
    std::string inputTXT, outputTXT, text;

    std::cout << "What .txt file do you want to read: ";
    std::getline(std::cin, inputTXT);

    std::cout << "What .txt do you want it to go into: ";
    std::getline(std::cin, outputTXT);
