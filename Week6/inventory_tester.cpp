...
int main() {
    ...
    if (inventory.addBook(book1)) std::cout << "Added book: " << book1.getTitle() << std::endl;
    if (inventory.addBook(book2)) std::cout << "Added book: " << book2.getTitle() << std::endl;
    if (inventory.addBook(book3)) std::cout << "Added book: " << book3.getTitle() << std::endl;
    if (inventory.addBook(book4)) std::cout << "Added book: " << book4.getTitle() << std::endl;
    if (inventory.addBook(book5)) std::cout << "Added book: " << book5.getTitle() << std::endl;
    if (inventory.addBook(book6)) std::cout << "Added book: " << book6.getTitle() << std::endl;
